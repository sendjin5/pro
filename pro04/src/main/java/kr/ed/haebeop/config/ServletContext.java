...
//        registry.addResourceHandler("/fileboard/**").addResourceLocations("/WEB-INF/views/fileboard");
//        registry.addResourceHandler("/dataBoard/**").addResourceLocations("/WEB-INF/views/dataBoard");
//        registry.addResourceHandler("/dataFile/**").addResourceLocations("/WEB-INF/views/dataFile");
    }
