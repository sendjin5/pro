...
<jsp:include page="../include/header.jsp" />
    <div class="pcoded-main-container">
        <div class="pcoded-content">
            ...
            <!-- [ breadcrumb ] end -->
            <!-- [ Main Content ] start -->
            <form action="${path }/lecture/lectAdd.do" name="frm1" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control d-inline-block" name="teacherId" id="teacherId" style="width:calc(100% - 170px)">
                                            <input type="text" class="form-control d-inline-block" name="teacherNm" id="teacherNm" style="width:calc(100% - 170px)">
