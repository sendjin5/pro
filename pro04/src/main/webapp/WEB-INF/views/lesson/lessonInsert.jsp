...
<jsp:include page="../include/header.jsp" />
            ...
            <div class="columns">
                <div class="column is-12">
                    <div class="block has-text-centered">
                        <h1 class="is-capitalize text-lg font-happy">강의 등록하기</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section blog-wrap container">
        <table class="table">
        <form action="${path }/lesson/insert" method="post">
                <table id="table1" class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="input" type="text" name="teacher" id="teacher" placeholder="강사 입력" maxlength="98" required>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <script>
                                CKEDITOR.replace('content',	{filebrowserUploadUrl:'${path }/dataFile/imageUpload'});
                            </script>
                        </td>
                    </tr>
                    <tr>
                ...
                <div class="buttons is-centered">
                    ...
                    <a class="button is-success" href="${path }/lesson/list">글 목록</a>
                </div>
            </form>
