        ...
        <div class="columns">
            <div class="column is-12">
                <div class="block has-text-centered">
                    <h1 class="is-capitalize text-lg font-happy">회원 약관</h1>
                </div>
            </div>
        </div>
    </div>
...
<div class="content container login_area">
    ...
    <div class="agree_fr box">
        ...
        본 약관은 (주)해법수학(이하 “회사”라 합니다)이 운영하는 웹사이트 ‘해법수학’(www.Haebeop.com) (이하 “웹 사이트”라 합니다)에서 제공하는 온라인 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버몰과 이용자의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.
    ...
    <div class="agree_fr box">
        주식회사 해법수학('이하 회사'라 함)는『개인정보 보호법』 및 『정보통신망 이용촉진 및 정보보호 등에 관한 법률』, 통신비밀보호법, 전기통신사업법, 등 정보통신서비스제공자가 준수하여야 할 관련 법령상의 개인정보보호 규정을 준수하며, 관련 법령에 의거한 개인정보처리방침을 정하여 이용자 권익 보호에 최선을 다하고 있습니다.
...
<script>
    ...
    in_btn1.addEventListener("click", function(){
        if(ck_item1.checked && ck_item2.checked) {
            location.href = "${path }/member/type";
